                ...
                <div class="big__freme">
                    <div class="big__freme__container">
                        @if (Auth::user()->is_favorites($favorite->id))
                            {{-- お気に入り解除のボタンのフォーム --}}
                            {!! Form::open(['route' => ['favorites.unfavorite', $favorite->id], 'method' => 'delete','class' => "big__freme__container-form"]) !!}
                                {!! Form::button('<i class="fas fa-heart big__freme__container-btn big__freme__container-btn--unfavorite""></i>', 
